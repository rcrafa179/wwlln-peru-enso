...
| Documento | Para qué |
|---|---|
| `README.es.md` (este) | Visión general, decisiones metodológicas, resultados |
| `README.md` | Este mismo documento, en inglés |
...
inconsistente. Los archivos afectados se conservan en cuarentena fuera del
repositorio (`_obsoleto_2025/`, local), con el detalle en su LEEME.
...
├── README.md                        el mismo documento, en inglés
...
Fuera del repositorio, por peso o por criterio de publicación: los `.mat` crudos,
los `.parquet` intermedios, `_obsoleto_2025/` (lo descartado, con su explicación)
y `SUMMARY_EN.md`.
